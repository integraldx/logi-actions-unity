namespace Loupedeck.Unity3DPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Unity3DPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Unity3DPlugin.Resources.Resource.txt`.
